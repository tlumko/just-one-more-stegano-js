...
function transformInput(input) {
  ...
  input.dataLength = fromDec(input.data.length, defaults.system);
  input.nameLength = fromDec(input.name.length, defaults.system);
  console.log(input);

  return input.dataLength + defaults.ETXChar +
    input.nameLength + defaults.ETXChar +
